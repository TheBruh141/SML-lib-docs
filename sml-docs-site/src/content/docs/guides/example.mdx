...
<CardGrid>
    <Card title="Taylor series on sin">
        <Image src={import("/src/assets/math/Taylor Series Sin Wikipedia.png")}
               alt={"a picture showing how a Taylor polynomial works on sin "} style={"border-radius:1rem; background-color:#ffffff;"}></Image>
    ...
    <Card title="Taylor series on <math>ln(1+x)</math>">
        <Image src={import("/src/assets/math/Taylor Series Log Wikipedia.gif")}
               alt={"a gif showing how taylor series works on ln(1+x)"} style={"border-radius:1rem; background-color:#ffffff;"}></Image>
